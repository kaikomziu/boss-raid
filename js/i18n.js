...
const JA = {
  ...
  // 遊び方
  'help.body': '100万HPのボスを世界中のプレイヤーとリアルタイム協力で連打して倒すゲーム。倒すたび少しずつ強い次のボスが無限に出現します。<br>画面のどこをクリック/タップしてもOK。ときどき光る<b>弱点</b>を叩くとダメージ2倍。キーボード操作なら、弱点が出ている間にこうげきキーを押せば自動で会心になります。',
